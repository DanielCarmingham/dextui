#!/usr/bin/env bash
#
# run.sh — launch the Rust dex-tui against the dex store for YOUR current directory.
#
...
#
#   cd ~/some/project && ~/Developer/DanielCarmingham/dex-tui/rust/run.sh
#
# Options:
